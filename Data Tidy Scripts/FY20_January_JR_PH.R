...
write.csv(queriedRecords_JUNIOR, "C:/Users/christine.iyer/Box/Search Test/Tidied Data Sets/FY20_January_JR.csv", row.names = F)
write.csv(queriedRecords_SOPHOMORE, "C:/Users/christine.iyer/Box/Search Test/Tidied Data Sets/FY20_January_PH.csv", row.names = F)