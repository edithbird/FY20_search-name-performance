...
write.csv(April_queriedRecords_JUNIOR, "C:/Users/christine.iyer/Box/Search Test/Tidied Data Sets/FY20_April_JR.csv", row.names = F)
write.csv(April_queriedRecords_SOPHOMORE, "C:/Users/christine.iyer/Box/Search Test/Tidied Data Sets/FY20_April_PH.csv", row.names = F)